...
CREATE TABLE IF NOT EXISTS "salespersons_salesperson" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "bio" text NOT NULL, "username_id" integer NOT NULL UNIQUE REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED);
CREATE TABLE IF NOT EXISTS "customers_customer" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(120) NOT NULL, "notes" text NOT NULL, "pic" varchar(100) NOT NULL);
INSERT INTO customers_customer VALUES(1,'Test Customer','1st customer','customers/129421295_l_normal_none.jpg');
CREATE TABLE IF NOT EXISTS "books_book" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(120) NOT NULL, "author_name" varchar(120) NOT NULL, "book_type" varchar(12) NOT NULL, "genre" varchar(12) NOT NULL, "price" real NOT NULL, "pic" varchar(100) NOT NULL);
...
INSERT INTO books_book VALUES(2,'Lord of the Rings','J.R.R. Tolken','hardcover','classic',47.0,'books/LOFTR.jpg');
CREATE TABLE IF NOT EXISTS "sales_sale" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "price" decimal NOT NULL, "book_id" bigint NOT NULL REFERENCES "books_book" ("id") DEFERRABLE INITIALLY DEFERRED, "created_at" datetime NOT NULL, "quantity" integer NOT NULL);
